...
web build:
 - http://mootools.net/core/0a0c799ce3f4014a8cd96e94d3d995dd

packager build:
 - packager build Core/Fx.Tween Core/Fx.Transitions
...
}};var d=function(h){var g=e[h];if(g){g.erase(this);if(!g.length&&c[h]){delete e[h];c[h]=clearInterval(c[h]);}}};})();(function(){var k=this.document;var i=k.window=this;
